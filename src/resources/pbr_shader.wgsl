...
struct InstanceInput {
    ...
    @location(15) materialIndex: u32,
    @location(16) textureIndex: u32,
    @location(17) normalIndex: u32,
};
...
@group(0) @binding(5) var<uniform> l: array<MaterialProperties, 1024>;
